...
// AI regeneration of one question lives in service-paper-question-regen.ts
// (split to stay under 350 lines).
export { regeneratePaperQuestion } from './service-paper-question-regen.js';
